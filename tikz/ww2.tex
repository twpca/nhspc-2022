...
\begin{document}
   \begin{tikzpicture}
      ...
      \draw (120: \RRR) node[anchor=north west]{\footnotesize$w_1$};
      ...
      \draw (90: 2*\RRR) node[anchor=south]{\footnotesize$w$};
      ...
      \filldraw[black] (90: 2*\RRR) circle(1pt);
      \draw[thick] (90: \R) -- (150: \R);
      \draw[thick] (150: \R) -- (180: \RRR);
      \draw[thick] (180: \RRR) -- (90: 2*\RRR);
      \draw[thick] (90: 2*\RRR) -- (90: \R);
   \end{tikzpicture}
\end{document}
